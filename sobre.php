...
<section class="section">
  <div class="container has-text-centered">
    ...
    <div class="box mx-auto" style="max-width: 850px;">
      <div class="columns is-vcentered is-centered mb-6">
        <div class="column is-narrow">
          <div class="is-flex is-justify-content-center is-align-items-center">
            <figure class="image is-128x128">
              <img class="is-rounded" src="assets/img/jhonathan.jpeg" alt="Foto de Jhonathan">
            </figure>
          </div>
        </div>
      ...
      <div class="columns is-vcentered is-centered mb-6">
        <div class="column is-narrow">
          <div class="is-flex is-justify-content-center is-align-items-center">
            <figure class="image is-128x128">
              <img class="is-rounded" src="assets/img/davi.jpg" alt="Foto de Davi">
            </figure>
          </div>
        </div>
